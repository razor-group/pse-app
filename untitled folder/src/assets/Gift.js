...
const SvgGift = (props) => (
  ...
  >
    ...
    <path
      stroke={props.color}
      strokeLinecap="round"
      d="M5 13h14m-7-6v13m0-13-.879-.879a9.713 9.713 0 0 0-3.796-2.346v0A1.766 1.766 0 0 0 5 5.45v.182c0 .817.523 1.542 1.297 1.8L8 8m4-1 .879-.879a9.714 9.714 0 0 1 3.796-2.346v0A1.766 1.766 0 0 1 19 5.45v.182c0 .817-.523 1.542-1.297 1.8L16 8"
    />
  </svg>
);
